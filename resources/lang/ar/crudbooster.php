...
return [
    ...
    'forgot_message' => 'أدخل بريدك الإلكتروني لاستعادة كلمة المرور',
    ...
    'text_enter_the_password' => 'فضلاً أدخل كلمة المرور لتسجيل الدخول',
    'text_or_sign_in' => 'او سجل الدخول بمهندس مختلف',
    'text_default_add_new_module' => 'إضافة :module جديد',
    'text_default_list_module' => 'عرض :module',
    'text_default_help_password' => '٥ أحرف فما فوق ، اترك الحقل فارغا اذا لا تريد تغيير كلمة المرور',
    'text_default_help_upload' => 'الملفات المدعومة : JPG, JPEG, PNG, GIF, BMP',
    'text_default_help_number' => 'أدخل ارقام فقط',
    'text_default_help_email' => 'صيغة البريد الإلكتروني غير صحيحة',
    'text_default_help_text' => 'فضلاً أدخل أحرف فقط',
    'text_default_help_url' => 'فضلاً أدخل رابط إلكتروني صحيح',
    'text_dashboard' => 'الرئيسية',
    'text_prefix_option' => '** فضلاً اختر',
    'text_loading' => 'فضلاً الانتظار جاري التحميل ...',

    'message_after_logout' => 'شكراً لك ، نراك لاحقاً !',
    'message_forgot_password' => 'تم ارسال كلمة المرور إلى بريدك الإلكتروني !',

    'page_not_found' => 'عفواً الصفحة غير موجودة',
    'page_not_found_text' => 'لم يتم العثور على الصفحة التي تبحث عنها.',
    'page_not_found_tips' => '* تأكد من ان الرابط صحيح<br/>
                * تأكد من الأحرف فهي حساسة للحالة<br/>
    ...
    'log_try_add' => 'حاول إضافة بيانات في :module',
    'log_try_add_save' => 'حاول إضافة بيانات :name data في :module',
    ...
    'log_add' => 'إضافة بيانات جديدة :name في :module',
    ...
    'alert_delete_selected' => 'هل أنت متأكد من حئف كافة البيانات المحددة ?',
    'alert_delete_selected_success' => 'البيانات المحددة تم حذفها بنجاح !',
    'alert_bulk_action_button' => 'هل أنت متأكد من',
    'alert_action' => 'تم :action بنجاح !',
    'alert_add_data_success' => 'تم إضافة البيانات !',
    ...
    'alert_session_expired' => 'عفواً انتهت جلسة العمل ، فضلاً اعد تسجيل الدخول !',
    'alert_password_wrong' => 'عفواًً كلمة المرور خاطئة !',
    'alert_required' => 'فضلاً اكمل كافة الحقول المطلوبة',
    'alert_error_ajax' => 'عفواً لقد حصل خطا ما ، سيتم حل المشكلة في اقرب وقت ممكن !',
    'alert_validation_error' => 'فضلاً اكمل الحقول بشكل صحيح : :error',
    ...
    'add_data_page_title' => 'إضافة :module',
    ...
    'delete_title_confirm' => "هل أنت متأكد ؟",

    'action_show_data' => 'تحديث',
    'action_add_data' => 'إضافة ',
    ...
    'Cancel' => 'إلغاء',
    'button_cancel' => 'إلغاء',
    'button_add' => 'إضافة بيانات',
    'button_edit' => 'تعديل بيانات',
    'button_back' => 'للخلف',
    'button_save' => 'حفظ',
    'button_send' => 'إرسال',
    'button_save_more' => 'حفظ وإضافة المزيد',
    'button_import' => 'استيراد البيانات',
    'button_export' => 'طباعة PDF',
    ...
    "file_broken" => "الملف معطوب ، فضلاً احذف الملف واعد المحاولة .",

    'denied_access' => 'عفواً لاتملك الصلاحيات اللازمة للوصول لهذه الصفحة !',
    'denied_update' => 'عفواً لاتملك الصلاحيات اللازمة لتحديث البيانات !',
    'denied_create' => 'عفواً لاتملك الصلاحيات اللازمة لإنشاء بيانات جديدة !',
    'denied_delete' => 'عفواً لاتملك الصلاحيات اللازمة لحذف البيانات !',

    'user_image' => 'الصورة الرمزية للمهندس',
    'online' => 'متصل',
    ...
    'Add_New_Privilege' => 'إضافة صلاحية',
    'List_Privilege' => 'عرض الصلاحيات',
    'add_user' => 'إضافة مهندس',
    'List_users' => 'عرض المهندسين',
    'Menu_Management' => 'إدارة القوائم',
    'Add_New_Setting' => 'إضافة اعدادات',
    'Add_New_Module' => 'إضافة تطبيق',
    'List_Module' => 'عرض التطبيقات',
    'Add_New_Statistic' => 'إضافة احصائيات',
    'List_Statistic' => 'عرض الاحصائيات',
    'Add_New_API' => 'إضافة API',
    ...
    'Users_Management' => 'إدارة المهندسين',
    'list_API' => 'عرض API',
    'Generate_Screet_Key' => 'انشاء مفتاح',
    'Add_New_Email' => 'إضافة قالب جديد',
    ...
    'confirmation_no' => 'لا',
    'confirmation_title' => 'التأكد',
    'confirmation_text' => 'هل أنت متأكد من القيام بذلك؟',
    ...
    'privileges_standart_user' => 'مهندس',
    'privileges_ID' => 'م',
    ...
    'please_complete_the_form' => 'فضلاً اكمل كافة حقول النموذج !',
    ...
    'file_status'  => [
        ...
        'done' => 'تم المعالجة',
        'failed' => 'فشل الاستيراد لعدم تطابق الملف مع النوع'
    ],
    'file_type' => [
