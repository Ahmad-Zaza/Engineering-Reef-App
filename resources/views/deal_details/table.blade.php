<style>
    #table_dashboard tr td:last-child,#table_dashboard tr th:last-child {
        width: 2%!important;
    }
</style>
@push('bottom')
                ...
                <div class="modal-content">
                    ...
                    <form method='get' action=''>
                                ...
                                <div class='row-filter-combo row'>
                                    ...
                                    <div class='col-sm-3'>
                                        <select name='filter_column[{{ $col['field_with'] }}][type]'
                                            ...
                                            <option value=''>**
                                                {{ trans('crudbooster.filter_select_operator_type') }}
                                            </option>
                                            ...
                                            @if (in_array($col['type_data'], ['int', 'integer', 'double', 'float', 'decimal', 'time']))
                                                <option
                                                    {{ CRUDBooster::getTypeFilter($col['field_with']) == '>=' ? 'selected' : '' }}
                                                    value='>='>
                                                    {{ trans('crudbooster.filter_greater_than_or_equal') }}
                                                </option>
                                            @endif
                                            @if (in_array($col['type_data'], ['int', 'integer', 'double', 'float', 'decimal', 'time']))
                                                <option
                                            ...
                                            @if (in_array($col['type_data'], ['int', 'integer', 'double', 'float', 'decimal', 'time']))
                                                <option
                                                    {{ CRUDBooster::getTypeFilter($col['field_with']) == '>' ? 'selected' : '' }}
                                                    value='>'>{{ trans('crudbooster.filter_greater_than') }}
                                                </option>
                                            @endif
                                            <option typeallow='all'
                                                {{ CRUDBooster::getTypeFilter($col['field_with']) == '!=' ? 'selected' : '' }}
                        ...
                        <input type="hidden" name="lasturl"
                            value="{{ Request::get('lasturl') ?: Request::fullUrl() }}">
                    </form>
                </div>
                <!-- /.modal-content -->
            </div>
