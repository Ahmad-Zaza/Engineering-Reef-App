        ...
        <div class="login-box-body">
            ...
            <form action="{{ route('postForgot') }}" method="post">
                ...
                <div class="form-group has-feedback">
                    <input type="email" class="form-control text-right" name='email' required placeholder="البريد الإلكتروني" />
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <button type="submit"
                            class="btn btn-primary btn-block btn-flat">{{ trans('crudbooster.button_send') }}</button>
                    </div><!-- /.col -->
                </div>
            </form>
