<style>
    .sidebar-menu>li.static:hover>a {
                ...
                @if (CRUDBooster::isSuperadmin())
                    ...
                    <li class='treeview'>
                        <a href='#'><i class='fa fa-users'></i>
                            <span>{{ trans('crudbooster.Users_Management') }}</span> <i
                        ...
                        <ul class='treeview-menu'>
                            <li
                                ...
                                <a href='{{ Route('AdminCmsUsersControllerGetAdd') }}'><i class='fa fa-plus'></i>
                                    <span>{{ trans('crudbooster.add_user') }}</span></a>
                            </li>
                            <li
                                class="{{ Request::is(config('crudbooster.ADMIN_PATH') . '/users') ? 'active' : '' }}">
                                <a href='{{ Route('AdminCmsUsersControllerGetIndex') }}'><i class='fa fa-bars'></i>
                                    <span>{{ trans('crudbooster.List_users') }}</span></a>
                            </li>
                        </ul>
                    </li>
                    @if (Crudbooster::me()->id == 1)
                        <li class="{{ Request::is(config('crudbooster.ADMIN_PATH') . '/logs*') ? 'active' : '' }}"><a
                                href='{{ Route('LogsControllerGetIndex') }}'><i class='fa fa-flag'></i>
                                <span>{{ trans('crudbooster.Log_User_Access') }}</span></a></li>
                        <li
                    ...
                    @if (1 == 1)
                            ...
                            <ul class='treeview-menu'>
                                <li
                                    ...
                                    <a href='{{ Route('PrivilegesControllerGetAdd') }}'>{{ $current_path }}<i
                                            class='fa fa-plus'></i>
                                        <span>{{ trans('crudbooster.Add_New_Privilege') }}</span></a>
                                </li>
                                <li
                                    ...
                                    <a href='{{ Route('PrivilegesControllerGetIndex') }}'><i class='fa fa-bars'></i>
                                        <span>{{ trans('crudbooster.List_Privilege') }}</span></a>
                                </li>
                            </ul>
                        </li>

                        <li class="treeview">
                            <a href="#"><i class='fa fa-wrench'></i> <span>{{ trans('crudbooster.settings') }}</span>
                                <i
                                    class="fa fa-angle-{{ trans('crudbooster.right') }} pull-{{ trans('crudbooster.right') }}"></i></a>
                            <ul class="treeview-menu">
                                <li
                                    ...
                                    <a href='{{ route('SettingsControllerGetAdd') }}'><i class='fa fa-plus'></i>
                                        <span>{{ trans('crudbooster.Add_New_Setting') }}</span></a>
                                </li>
                                <?php
                        ...
                        <li class='treeview'>
                            <a href='#'><i class='fa fa-th'></i>
                                <span>{{ trans('crudbooster.Module_Generator') }}</span> <i
                                    class="fa fa-angle-{{ trans('crudbooster.right') }} pull-{{ trans('crudbooster.right') }}"></i></a>
                            <ul class='treeview-menu'>
                                <li
                                    ...
                                    <a href='{{ Route('ModulsControllerGetStep1') }}'><i class='fa fa-plus'></i>
                                        <span>{{ trans('crudbooster.Add_New_Module') }}</span></a>
                                </li>
                                <li
                                    ...
                                    <a href='{{ Route('ModulsControllerGetIndex') }}'><i class='fa fa-bars'></i>
                                        <span>{{ trans('crudbooster.List_Module') }}</span></a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class='treeview'>
                            ...
                            <ul class='treeview-menu'>
                                <li
                                    ...
                                    <a href='{{ Route('StatisticBuilderControllerGetAdd') }}'><i
                                            class='fa fa-plus'></i>
                                        <span>{{ trans('crudbooster.Add_New_Statistic') }}</span></a>
                                </li>
                                <li
                                    class="{{ Request::is(config('crudbooster.ADMIN_PATH') . '/statistic_builder') ? 'active' : '' }}">
                                    <a href='{{ Route('StatisticBuilderControllerGetIndex') }}'><i
                                            class='fa fa-bars'></i>
                                        <span>{{ trans('crudbooster.List_Statistic') }}</span></a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class='treeview'>
                            <a href='#'><i class='fa fa-fire'></i>
                                <span>{{ trans('crudbooster.API_Generator') }}</span> <i
                                    class="fa fa-angle-{{ trans('crudbooster.right') }} pull-{{ trans('crudbooster.right') }}"></i></a>
                            <ul class='treeview-menu'>
                                <li
                                    class="{{ Request::is(config('crudbooster.ADMIN_PATH') . '/api_generator/generator*') ? 'active' : '' }}">
                                    <a href='{{ Route('ApiCustomControllerGetGenerator') }}'><i
                                            class='fa fa-plus'></i>
                                ...
                                <li
                                    ...
                                    <a href='{{ Route('ApiCustomControllerGetIndex') }}'><i class='fa fa-bars'></i>
                                        <span>{{ trans('crudbooster.list_API') }}</span></a>
                                </li>
                                <li
                                    class="{{ Request::is(config('crudbooster.ADMIN_PATH') . '/api_generator/screet-key*') ? 'active' : '' }}">
                                    <a href='{{ Route('ApiCustomControllerGetScreetKey') }}'><i
                                            class='fa fa-bars'></i>
                        ...
                        <li class='treeview'>
                            <a href='#'><i class='fa fa-envelope-o'></i>
                                <span>{{ trans('crudbooster.Email_Templates') }}</span> <i
                                    class="fa fa-angle-{{ trans('crudbooster.right') }} pull-{{ trans('crudbooster.right') }}"></i></a>
                            <ul class='treeview-menu'>
                                <li
                                    class="{{ Request::is(config('crudbooster.ADMIN_PATH') . '/email_templates/add*') ? 'active' : '' }}">
                                    <a href='{{ Route('EmailTemplatesControllerGetAdd') }}'><i
                                            class='fa fa-plus'></i>
                                        <span>{{ trans('crudbooster.Add_New_Email') }}</span></a>
                                </li>
                                <li
                                    class="{{ Request::is(config('crudbooster.ADMIN_PATH') . '/email_templates') ? 'active' : '' }}">
                                    <a href='{{ Route('EmailTemplatesControllerGetIndex') }}'><i
                                            class='fa fa-bars'></i>
                                        <span>{{ trans('crudbooster.List_Email_Template') }}</span></a>
                                </li>
                            </ul>
                        </li>

                        <li class="{{ Request::is(config('crudbooster.ADMIN_PATH') . '/logs*') ? 'active' : '' }}">
                            <a href='{{ Route('LogsControllerGetIndex') }}'><i class='fa fa-flag'></i>
