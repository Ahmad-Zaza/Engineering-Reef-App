...
<header class="main-header">
    ...
    <!-- Logo -->
    <a href="{{url(config('crudbooster.ADMIN_PATH'))}}"  class="logo">نقابة المهندسين - ريف دمشق</a>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="">
                    <a href="https://api.whatsapp.com/send/?phone=963991060638&text&app_absent=0" target="_blank">
                        <span class="fa fa-whatsapp text-white"> الدعم الفني</span>
                    </a>
                </li>

                <li class="">
                    <a href="{{url('support_file.pdf')}}" target="_blank" style="text-decoration:none;">
                        <span class="fa fa-download text-white">
                            <span>كتاب إرشادي للدخول إلى التطبيق</span>
                        </span>
                    </a>
                </li>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            ...
                            <div class="pull-{{ trans('crudbooster.right') }}">
                                <a title='قفل النظام' href="{{ route('getLockScreen') }}" class='btn btn-default btn-flat'><i class='fa fa-key'></i></a>
