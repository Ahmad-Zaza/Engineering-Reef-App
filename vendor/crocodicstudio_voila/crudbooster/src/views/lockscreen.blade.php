...
<body class="lockscreen">
    ...
    <div class="lockscreen-wrapper">
            ...
            <form class="lockscreen-credentials" method='post'
                ...
                <div class="input-group">
                    ...
                    <div class="input-group-btn">
                        <button class="btn"><i class="fa fa-arrow-left text-muted"></i></button>
                    </div>
                </div>
        ...
        <div class='text-center'>
            <a href="{{ route('getLogout') }}" style="color:#c5161c;">{{ trans('crudbooster.text_or_sign_in') }}</a>
        </div>
        <div class='lockscreen-footer text-center'>
            <strong>
                MyOSEA @ <?php echo date('Y'); ?> by <a target="_blank" href="https://voila.digital">Voila</a> | All Rights
                Reserved
            </strong>
