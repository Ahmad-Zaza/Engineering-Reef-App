...
Route::group(['middleware' => ['web'], 'prefix' => config('crudbooster.ADMIN_PATH'), 'namespace' => $namespace], function () {
    ...
    Route::get('Welcome-Engineer', ['uses' => 'AdminController@InitgetLogin', 'as' => 'InitgetLogin']);
    Route::post('Welcome-Engineer', ['uses' => 'AdminController@InitpostLogin', 'as' => 'InitpostLogin']);
    Route::get('Init-Engineer-User', ['uses' => 'AdminController@InitGetEngineerUser', 'as' => 'InitGetEngineerUser']);
    Route::post('Init-Engineer-User', ['uses' => 'AdminController@InitEngineerUser', 'as' => 'InitEngineerUser']);
