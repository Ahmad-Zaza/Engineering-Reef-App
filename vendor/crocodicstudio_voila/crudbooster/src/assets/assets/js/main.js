...
function beep() {
  $("#sound_beep").remove();
  $("body").append(
    '<audio id="sound_beep" style="display:none" autoplay>' +
      +'<source src="' +
      ASSET_URL +
      '/vendor/crudbooster/assets/sound/bell_ring.ogg" type="audio/ogg">' +
      '<source src="' +
      ASSET_URL +
      '/vendor/crudbooster/assets/sound/bell_ring.mp3" type="audio/mpeg">' +
...
function loader_notification() {
  $.get(NOTIFICATION_JSON, function (resp) {
    ...
    $(".notifications-menu .header").text(
