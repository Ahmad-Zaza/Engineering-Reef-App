...
class LogsController extends CBController
{
    public function cbInit()
    {
        ...
        $this->col = [];
        $this->col[] = ["label" => "وقت العملية", "name" => "created_at"];
        $this->col[] = ["label" => "IP Address", "name" => "ipaddress"];
        $this->col[] = ["label" => "المهندس", "name" => "id_cms_users", "join" => config('crudbooster.USER_TABLE').",name"];
        $this->col[] = ["label" => "رقم المهندس", "name" => "id_cms_users", "join" => config('crudbooster.USER_TABLE').",num"];

        $this->col[] = ["label" => "التفاصيل", "name" => "description"];

        $this->form = [];
        $this->form[] = ["label" => "وقت العملية", "name" => "created_at", "readonly" => true];
        $this->form[] = ["label" => "IP Address", "name" => "ipaddress", "readonly" => true];
        $this->form[] = ["label" => "المتصفح", "name" => "useragent", "readonly" => true];
        $this->form[] = ["label" => "الرابط", "name" => "url", "readonly" => true];
        $this->form[] = [
            "label" => "اسم المهندس",
            "name" => "id_cms_users",
            "type" => "select",
        ...
        $this->form[] = [
            ...
            "name" => "id_cms_users",
            "type" => "select",
            "datatable" => config('crudbooster.USER_TABLE').",num",
            "readonly" => true,
        ];
