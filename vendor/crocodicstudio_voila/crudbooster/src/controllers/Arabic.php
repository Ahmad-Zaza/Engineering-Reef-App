            ...
            if (count($p) > 0) {
                ...
                for ($i = 0; $i < $max; $i += 2) {
                    ...
                    if ($i + 2 < $max) {
                        ...
                        $blockArr = substr($str, $p[$i + 1], strlen($str) - $p[$i + 1]);
                    }
                    //LAMA
                    // $blockArr = array_reverse(explode(" ",$blockArr));
                    // $block[] = implode(" ",$blockArr);
                    $block[] = $blockArr;
                }
